...
- [ ] Optional follow-up (not done, not asked for): delete the now-worktree-less local branches `vargr/objective-sinoussi-6193de` / `vargr/optimistic-sinoussi-38bf13` — both are fully merged, `git branch -d` would succeed safely on either
