...
- [ ] T-P6-01 — Incomplete-construct detector
- [ ] T-P6-02 — Block-boundary segmentation
- [ ] T-P6-03 — Stable-prefix reconciliation
- [ ] T-P6-04 — `useStreamingMarkdown` hook
- [ ] T-P6-05 — LRU cache, capacity 100
- [ ] T-P6-06 — Bounded-memory guard
